...
export default function ProgressBar({ progressData }: { progressData: ProgressData }) {
  const { progress, scorePercent, maxScorePercent, averageScorePercent } = progressData
